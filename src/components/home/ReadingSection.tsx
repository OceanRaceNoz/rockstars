...
const ReadingSection: React.FC = () => {
  ...
  return (
    <div className="w-full mt-10 mb-16">
      ...
      />
      <div className="w-full mt-[15px] px-5">
        <div className="flex items-center gap-5">
          <div className="w-[215px] rounded-md">
            <div className="shadow-[-20px_94px_27px_0px_rgba(0,0,0,0.00),-13px_60px_25px_0px_rgba(0,0,0,0.01),-7px_34px_21px_0px_rgba(0,0,0,0.05),-3px_15px_15px_0px_rgba(0,0,0,0.09),-1px_4px_8px_0px_rgba(0,0,0,0.10)] bg-[#F7FBFF] flex flex-col items-stretch pt-[15px] px-[15px] rounded-[6.143px]">
              ...
              <div className="bg-[rgba(0,175,234,1)] text-lg text-neutral-50 font-bold text-center mt-10 pt-[9px] px-2.5 rounded-t-[0px]">
                <div className="bg-[rgba(0,56,108,1)] px-2.5 rounded-t-[0px]">
                  <div className="flex flex-col relative z-10 aspect-[0.831] mt-[-33px] w-[133px] mx-auto pt-[43px]">
                    <img
                    ...
                    />
                    <div className="relative border bg-[rgba(0,25,49,1)] pt-12 pb-[25px] px-[13px] rounded-t-[0px] border-[rgba(137,137,137,1)] border-solid">
                      Louisa Riepe
                    </div>
                  </div>
                </div>
          ...
          <img
            ...
            alt="Reading content"
            className="aspect-[0.69] object-contain w-[120px] rounded-[5px]"
          />
        </div>
      </div>
    </div>
